...
package org.opensds.vmware.common.adapters.opensds;
...
import org.opensds.vmware.common.exceptions.NotAuthorizedException;
import org.opensds.vmware.common.Request;
import org.opensds.vmware.common.models.ALLOC_TYPE;
...
class RestClient {
    ...
    void login(String ip, int port, String user, String password) throws Exception {
        ...
        String endPoint = String.format("http://%s:12557/identity/v3", ip);

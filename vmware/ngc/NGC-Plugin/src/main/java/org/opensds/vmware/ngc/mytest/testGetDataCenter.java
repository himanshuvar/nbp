...
public class testGetDataCenter {
    ...
    public static List<ManagedObjectReference> getAllDatacenter() {
        ...
        //获取根目录对象引用
        ManagedObjectReference rootFolder = testVimContext.serviceContent.getRootFolder();
        try
        {
            ...
            List<ObjectContent> listobcont = testVimContext.retrievePropertiesALLObjects(listfps);

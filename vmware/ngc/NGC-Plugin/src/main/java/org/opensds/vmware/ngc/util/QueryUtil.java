...
public class QueryUtil {
     ...
     *
     * @param dataService The data service instance that will be used for retrieving
     *                    the property value.
     * @param obj         Object whose properties are required.
     * @param properties  The names of the object properties you need to retrieve.
     ...
     * will be returned.
     *
     * @param dataService DataService instance to use for retrieving the properties of the object.
     * @param objs        An array of object instances whose properties are required.
     * @param properties  Name of the properties to be requested.
     * @return Values of the requested properties. The array is flat: this means that
     * the property values for the different objects will be mixed in it, in no
     * particular order.
     * @throws Exception Throws <code>Exception</code> if invalid query parameters are passed.
     ...
     * dataService, vm, "datastore", "DatastoreInfoOld", new String[] {"name"});
     * if (names != null) {
     ...
     * }
     *
     * @param dataService  The data service to query about the properties.
     * @param obj          The root object for the relationship.
     * @param relationship The relationship string. A string referencing a property of the
     *                     <code>object</code> parameter.
     * @param targetType   The type of the object that the <code>relationship</code> will return.
     ...
     * @param properties   An array of string referencing properties on the objects returned when the
     *                     <code>relationship</code> is resolved.
     * @return An array of <code>PropetyValue</code> instances or null if the
     ...
     * @param query       QuerySpec for the data-service
     * @return ResultSet from the data-service
     * @throws Exception Throws <code>Exception</code> if an empty result is retrieved
     *                   for the query.
     */
     ...
     *
     * @param entity     - managed object of interest
     ...
     *
     * @param constraint A constraint which will define the set of object being considered for
     *                   property retrieval.
     * @param properties The properties we want to retrieve.
     * @return A <code>QuerySpec</code> which you can directly feed into a getData()
     ...
     *                    property retrieval.
     * @param properties  The properties we want to retrieve.
     * @param targetTypes For each target type in the set, a <code>PropertySpec</code> is created.
     ...
     * @param constraintOnRelatedObject constraint on the objects related to the targeted objects by the
     *                                  given relationship
     * @param hasInverseRelation        indicates whether the constraint given by constraintOnRelatedObject applies to the
     *                                  source, as opposed to the target of the relationship given in this instance
     * @param targetType                type of the objects to retrieve
     ...
     *
     * @param entity Object to be looked up

...
import com.opensds.esdk.model.AuthInfo;
import com.opensds.esdk.model.VCenterInfo;
import com.opensds.esdk.bean.ErrorCode;
import com.opensds.esdk.model.EventsInfo;
import com.opensds.esdk.model.TaskInfo;
...
public class XmlUtils {
    ...
    public List<AuthInfo> xmlReadAuthInfo(String local) {
        ...
        if (null == local) {
            logger.info("the local is null when read authInfoXml");
            return null;
        }
    ...
    public List<TaskInfo> xmlReadTaskInfo(String local) {
        ...
        if (null == local) {
            logger.info("the local is null when read taskInfoXml");
            return null;
        }
    ...
    public List<EventsInfo> xmlReadEventTypeInfo(String local) {
        ...
        if (null == local) {
            logger.error("The eventtypeinfo is null");
            return null;
        }
    ...
    public VCenterInfo xmlReadVcenterInfo(String path) {
        ...
        try {
            ...
            logger.error("Read XML error, ex : " + ex.getMessage());
        }
        return vcInfo;
    }
    ...
    private ErrorCode writeToXML(String path, Document doc) {
        ...
        try {
            ...
            logger.error("Writer xml error ;" + e.toString());
            ...
            if (xmlWriter != null) {
                try {
                    ...
                    logger.error("XMLWriter close error" + e.toString());
                }
            }
            closeStream(writer);
    ...
    public Document loadConigXml(String filename) {
        ...
        try {
            ...
            logger.error(String.format("the filename of document is %s, error [%s]" , filename
                    ,ex.getMessage()));
